...
class TestWorkflowEdges:
    ...
    def test_should_end_low_variance(self):
        ...
        state = SurveyState(
            ...
            parsed_content="content",
            evaluations=[
                {"agent_name": "verifier", "dimension": "factuality", "score": 7.5, "reasoning": "", "evidence": None, "confidence": 0.8},
                {"agent_name": "expert", "dimension": "depth", "score": 7.0, "reasoning": "", "evidence": None, "confidence": 0.9},
                {"agent_name": "reader", "dimension": "coverage", "score": 7.5, "reasoning": "", "evidence": None, "confidence": 0.8},
                {"agent_name": "corrector", "dimension": "bias", "score": 7.0, "reasoning": "", "evidence": None, "confidence": 0.75},
            ],
            debate_history=[],
            sections={},
            current_round=0,
    ...
    def test_should_end_high_variance(self):
        ...
        state = SurveyState(
            ...
            parsed_content="content",
            evaluations=[
                {"agent_name": "verifier", "dimension": "factuality", "score": 9.0, "reasoning": "", "evidence": None, "confidence": 0.8},
                {"agent_name": "verifier2", "dimension": "factuality", "score": 5.0, "reasoning": "", "evidence": None, "confidence": 0.9},
            ],
            debate_history=[],
            sections={},
            current_round=0,
